                            ...
                            ?>
                                <tr>
                                    <td class="text-center">
                                        <span class="badge-id" style="background: var(--gray-100); padding: 0.25rem 0.5rem; border-radius: 8px; font-family: monospace;">#<?= $row['aluno_id'] ?></span>
                                    </td>
                                    <td>
                                        ...
                                        <small class="<?= $frequenciaCor ?>">
                                            <i class="fas fa-chart-line me-1"></i> <?= number_format($frequencia, 1, ',', '.') ?>% de frequência
                                        </small>
                                    </td>
                                    <td class="text-center">
