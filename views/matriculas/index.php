...
// Incluir header padronizado (já carrega jQuery, Bootstrap, DataTables)
...
<!-- CSS adicional específico para matrículas -->
<style>
.loading-overlay {
    position: fixed;
    top: 0;
...
<!-- ============================================ -->
<!-- CONSTANTES GLOBAIS (declaradas ANTES do script) -->
<!-- ============================================ -->
<script>
...
<!-- ============================================ -->
<!-- SCRIPT PRINCIPAL (NÃO carregar bibliotecas duplicadas) -->
<!-- ============================================ -->
