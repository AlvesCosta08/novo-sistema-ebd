...
$total_aulas = $total_presencas + $total_ausencias;
$media_frequencia = $total_aulas > 0 
    ? round(($total_presencas / $total_aulas) * 100, 1) 
    : 0;
    ...
    <div class="row mb-4 g-4" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="col-6 col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-value"><?= number_format($total_ausencias, 0, ',', '.') ?></div>
    ...
    <div class="d-md-none mb-4" data-aos="fade-up" data-aos-delay="150">
        <?php if (!empty($results)): ?>
            <?php foreach ($results as $row): 
                $total_aulas_aluno = $row['total_presentes'] + $row['total_ausentes'];
                $frequencia = $total_aulas_aluno > 0 
                    ? round(($row['total_presentes'] / $total_aulas_aluno) * 100, 1) 
                    : 0;
                        ...
                        <div class="row mt-2">
                            <div class="col-6">
                                <div class="text-center p-2" style="background: rgba(16, 185, 129, 0.1); border-radius: 10px;">
                                    ...
                                    <div class="fw-bold text-success"><?= number_format($row['total_presentes'], 0, ',', '.') ?></div>
                            ...
                            <div class="col-6">
                                <div class="text-center p-2" style="background: rgba(239, 68, 68, 0.1); border-radius: 10px;">
                                    ...
                                    <div class="fw-bold text-danger"><?= number_format($row['total_ausentes'], 0, ',', '.') ?></div>
                ...
                <table id="tabelaFrequencia" class="custom-table mb-0" style="width:100%">
                        ...
                        <?php if (!empty($results)): ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge-presenca"><?= number_format($row['total_presentes'], 0, ',', '.') ?></span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge-falta"><?= number_format($row['total_ausentes'], 0, ',', '.') ?></span>
                                    </td>
                                    <td>
                    ...
                    <tfoot class="table-footer">
                        <tr>
                            ...
                            <td class="text-center fw-bold bg-success bg-opacity-10 text-success"><?= number_format($total_presencas, 0, ',', '.') ?></td>
                            <td class="text-center fw-bold bg-danger bg-opacity-10 text-danger"><?= number_format($total_ausencias, 0, ',', '.') ?></td>
...
@media (max-width: 768px) {
    ...
    .badge-presenca, .badge-falta { font-size: 0.75rem; padding: 0.25rem 0.6rem; }
}
</style>
